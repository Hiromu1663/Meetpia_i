    ...
    <div class="container px-5 py-12 mx-auto">
      <div class="lg:h-full mx-auto flex sm:flex-col sm:items-center md:flex-row">
        <div class="sm:w-96 md:w-60 lg:w-96 md:h-60 lg:h-96">
          <img alt="ecommerce" class="w-full h-full object-cover object-center rounded-full" src="https://dummyimage.com/400x400">
        </div>
        <div class="lg:w-4/6 lg:py-6 pl-5 mt-6 mb-3 lg:mt-0">
          {{-- <h2 class="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2> --}}
          
          <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">Name Surname</h1>
          <div class="flex">
          ...
          <ul class="space-x-2s mb-4">
            <li>
              <ul class="flex space-x-2s">
                <li class="text-gray-500 mr-3">gender</li>
                <li class="text-gray-500 mr-3">age</li>
                <li class="text-gray-500 mr-3">status</li>
              </ul>
            </li>
          {{-- 電話番号、メールアドレス、住所 --}}
            <li>phonenumber : ×××-××××-××××</li>
            <li>email : test1@gmail.com</li>
            <li>address : La Guardia Flats 2 Building, La Guardia St. Lahug Cebu City</li>
          </ul>
          {{-- ------------------------------------------------------------------------- --}}
