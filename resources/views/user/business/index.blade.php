                    ...
                    <section class="text-gray-600 body-font">
                        <div class="flex justify-center items-center">
                            <div class="relative flex rounded-md">
                              <input type="text" id="hs-trailing-button-add-on-with-icon-and-button" name="hs-trailing-button-add-on-with-icon-and-button" class="flex items-center justify-center w-full py-3 px-4 border-gray-200 shadow-sm rounded-l-md text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-5 dark:text-gray-400">
