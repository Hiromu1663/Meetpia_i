<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.deleted-users.index')" :active="request()->routeIs('admin.deleted-users.index')">
                        {{ __('Deleted Users') }}
                    </x-nav-link>
                </div>
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-nav-link :href="route('admin.deleted_project.index')" :active="request()->routeIs('admin.deleted_project.index')">
                        {{ __('Deleted Events') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.deleted-users.index')" :active="request()->routeIs('admin.deleted-users.index')">
                {{ __('削除済みユーザー') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.event')" :active="request()->routeIs('admin.event')">
                {{ __('Event') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('admin.deleted_project.index')" :active="request()->routeIs('admin.deleted_project.index')">
                {{ __('Deleted Events') }}
            </x-responsive-nav-link>
        </div>
