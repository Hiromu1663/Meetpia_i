              ...
              <div class="flex mb-4">
                ...
                <span class="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-2s">
                  ...
                  <td class="h-px w-px whitespace-nowrap">
                    <a href="{{ route('admin.deleted_project.restore', ['id'=>$project->id]) }}">
                      <button class="inline-flex text-white bg-indigo-500 border-0 py-2 px-6 ml-2 focus:outline-none hover:bg-indigo-600 rounded text-lg">Restore</button>
                    </a>
                  </td> 
                  <form action="{{ route('admin.deleted_project.destroy', ['id' => $project->id]) }}" method="POST" id="delete_{{$project->id}}">
                    @csrf
                    @method('delete')
